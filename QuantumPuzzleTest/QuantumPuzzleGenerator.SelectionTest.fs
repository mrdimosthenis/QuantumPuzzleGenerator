...
[<Fact>]
let ``Select puzzle for level 4`` () = numOfDiffQStates 3 |> should equal 64
...
[<Fact>]
let ``Select puzzle for level 11`` () = numOfDiffQStates 10 |> should equal 256

[<Fact>]
let ``Select puzzle for level 12`` () = numOfDiffQStates 11 |> should equal 512

[<Fact>]
let ``Select puzzle for level 13`` () = numOfDiffQStates 12 |> should equal 1024

[<Fact>]
let ``Select puzzle for level 14`` () = numOfDiffQStates 13 |> should equal 16

[<Fact>]
let ``Select puzzle for level 15`` () = numOfDiffQStates 14 |> should equal 16
